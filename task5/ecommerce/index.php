...
$productsResult = $productObject->getrecentprod('id,name_en,image,','name_en');
                    ...
                    <div class="col-3">
                        <div class="product-wrapper mb-30">
                            <div class="product-img">
                                ...
                                <a href="shop.php?brand= <?= $product['id'] ?>">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="shop.php?brand= <?= $product['id'] ?>"><?= $product['name_en'] ?></a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="shop.php?brand= <?= $product['id'] ?>">+ Add to cart</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
